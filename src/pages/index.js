  ...
  return (
    <Layout location={location}>
      ...
      <section className='intro'>
        ...
        <p style={textStyle}>
          I love JavaScript, TypeScript, Node.js and React ⚛️ and I’m building a few apps with React Native 📱
        </p>
        <p style={textStyle}>
          For data science and Raspberry Pi fun I’m learning Python 🐍, and I’m also dipping my toes into languages like
          .NET, Swift 🕊 and Rust 🦀.
        </p>
      </section>
      <Contact />
